...
export function IconContacts(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M18.5 14.5c1.6 1 2.5 2.6 2.5 4.5" />
    </svg>
  );
}
...
export function IconViewings(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function IconSavedSearches(props: IconProps) {
  return (
    <svg {...base(props)}>
...
export function IconCampaigns(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M4 14a8 8 0 0 1 8-8c1.5 0 3 .4 4 1v13c-1 0.6-2.5 1-4 1a8 8 0 0 1-8-8z" />
      <path d="M20 5v9" />
    </svg>
  );
}
...
export function IconIntegrations(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M10 13a5 5 0 0 0 7 0l1.5-1.5a5 5 0 0 0-7-7L10 6" />
      <path d="M14 11a5 5 0 0 0-7 0L5.5 12.5a5 5 0 0 0 7 7L14 18" />
    </svg>
  );
}
...
export function IconHealth(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 21s-7.5-5.2-9.4-9A5.3 5.3 0 0 1 12 6.2 5.3 5.3 0 0 1 21.4 12c-1.9 3.8-9.4 9-9.4 9z" />
      <path d="M12 8.5V15" />
    </svg>
  );
}
...
export function IconSparkle(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M5.6 5.6 8.4 8.4M15.6 15.6l2.8 2.8" />
      <path d="M18.4 5.6 15.6 8.4M8.4 15.6l-2.8 2.8" />
    </svg>
  );
}
